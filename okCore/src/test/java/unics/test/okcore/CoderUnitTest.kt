...
import unics.okcore.lang.toBase64DecodeString
import unics.okcore.lang.toBase64EncodeString
import unics.okcore.lang.toUrlDecode
import unics.okcore.lang.toUrlEncode
...
class CoderUnitTest {
    ...
    fun testBase64Coder() = runBlocking {
        ...
        //期望的base64结果：带换行
        val expectWraped =
            "ZXVjLWty5Luj6KGo6K+05piO57\r2R56uZ5piv6YeH55So55qE57yW56CB5piv6Z+p5paHOyAuLi7n\n" +
