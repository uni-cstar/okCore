...
import unics.okcore.converter.fastjson.FastJsonConverter;
...
public class Converters {
    ...
    static {
        try {
            //初始化默认JsonConverter，优先使用Moshi(更好支持Kotlin、Java)->Jackson(Kotlin版本)
            ...
            } else if (ClassesKt.isClassExists("com.fasterxml.jackson.module.kotlin.KotlinModule")) {
