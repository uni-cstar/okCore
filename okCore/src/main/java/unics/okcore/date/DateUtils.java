...
public class DateUtils {
    ...
    /**
     * 获取当前时间；其实这里可能存在问题，就是系统的时间未同步，只能依赖系统同步好时间
     */
    @NotNull
    ...
    public static String format(@Nullable Date date, @Nullable String pattern) {
        ...
        if (CN_DATETIME_PATTERN.equals(pattern)) {
            ...
            return new SimpleDateFormat(pattern, OkCoreKt.getGlobalLocale()).format(date);
        }
    }
