...
import bas.droid.core.graphics.fontHeight
import bas.droid.core.graphics.textCenterVerticalBaseY
...
//            }
        ...
        private val canvasWidth: Int
            get() {
                ...
                return if (width > 0)
                    width
                else holder?.surfaceFrame?.width().orDefault()
            }
